...
namespace FlaUInspect.ViewModels
{
    public class ElementViewModel : ObservableObject
    {
        ...
        string[] res;
        public ElementViewModel(AutomationElement automationElement, string[] res)
        {
            this.res = res;
            AutomationElement = automationElement;
            Children = new ExtendedObservableCollection<ElementViewModel>();
        ...
        public void LoadChildren(bool loadInnerChildren)
        {
            ...
            try
            {
                ...
                {
                    var childViewModel = new ElementViewModel(child, res);
        ...
        private List<DetailGroupViewModel> LoadDetails()
        {
            ...
            using (cacheRequest.Activate())
            {
                ...
                if (elementCached != null)
                {
                    ...
                    DetailViewModel a = DetailViewModel.FromAutomationProperty("AutomationId", elementCached.Properties.AutomationId);
                    a.Important = true;
                    ...
                    this.res[0] = identification[0].Value;
