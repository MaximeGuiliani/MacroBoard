...
namespace FlaUInspect.ViewModels
{
    ...
    {
        public HoverMode _hoverMode;
        public FocusTrackingMode _focusTrackingMode;
        private ITreeWalker _treeWalker;
        private AutomationBase _automation;
        private AutomationElement _rootElement;
        string[] res;

        public MainViewModel(string[] res)
        {
            this.res = res;
        ...
        public void Initialize(AutomationType selectedAutomationType)
        {
            ...
            var desktopViewModel = new ElementViewModel(_rootElement, res);
