...
namespace FlaUInspect.Core
{
    public class HoverMode
    {
        ...
        {
            if (/*System.Windows.Input.Keyboard.Modifiers.HasFlag(System.Windows.Input.ModifierKeys.Control)*/ System.Windows.Input.Keyboard.Modifiers == System.Windows.Input.ModifierKeys.Control)
            {
